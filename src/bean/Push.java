...
public class Push implements java.io.Serializable {
	...
	/** minimal constructor */
	public Push(String pushEditor, String pushStatus, String pushTitle, String pushKeyWord, String pushUrl, String pushDate) {
	...
	/** full constructor */
	public Push(String pushEditor, String pushStatus, String pushTitle, String pushKeyWord, String pushUrl, String pushDate, String pushContext) {
		this.pushEditor = pushEditor;
		this.pushStatus = pushStatus;
		this.pushTitle = pushTitle;
		this.pushKeyWord = pushKeyWord;
