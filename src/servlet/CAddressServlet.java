...
public class CAddressServlet extends ActionSupport {
	...
	public void doAdd() throws Exception {
		...
		CAddress object = gson.fromJson(caddressjson, CAddress.class);
		...
		CAddress db_caddress = caddressService.Add(object);
	...
	public void doUpdate() throws Exception {
		...
		CAddress db_caddress = caddressService.Update(object);
	...
	public void doDelete() throws Exception {
		...
		Customer db_customer = customerService.FindByToken(token);
		CAddress object = caddressService.View(caddressid);
		...
		if (!object.getCustomer().getCustomerId().equals(db_customer.getCustomerId())) {
			System.out.println(object.getCustomer().getCustomerId());
			System.out.println(db_customer.getCustomerId());
		}
		...
		if (!caddressService.Delete(object)) {
	...
	public void doView() throws Exception {
		...
		map = gson.fromJson(mapjson, java.util.HashMap.class);
		json = map.get("json");
		responsemsg = map.get("responsemsg");

		System.out.println("------->json:" + json);
		System.out.println("------->responsemsg:" + responsemsg);

		object = gson.fromJson(json, CAddress.class);
	...
	public void doFindByCustomer() throws Exception {
		...
		int firstPage = 1;
		int lastPage = 1;
		int totalRecord = caddressService.GetCountByCustomerId(db_customer.getCustomerId(), keyword);
		...
		List<?> list = caddressService.FindByCustomerId(db_customer.getCustomerId(), keyword, fromIndex, toIndex - fromIndex);// 可优化
