...
public class QRCodeUtil {
	 ...
	 * @throws Exception
	 */
	public static void encode_folder(String content, String imgPath, String folderPath, boolean needCompress)
			throws Exception {
		BufferedImage image = QRCodeUtil.createImage(content, imgPath, needCompress);
		mkdirs(folderPath);
		String file = new Random().nextInt(99999999) + ".jpg";
		ImageIO.write(image, FORMAT_NAME, new File(folderPath + "/" + file));
	}
	...
	public static void initQRCode() throws Exception {
		...
		test.log2alipay(root_path_attached + "-------" + root_url_attached, "initQRCode");
