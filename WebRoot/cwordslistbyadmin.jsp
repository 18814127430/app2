...
<%
    ...
    int adminid	=	(Integer)request.getAttribute("adminid");  //一共多少记录
...
<body>
	<form action="<%=basePath%>cwords/cwords_doFindByAdminId.action" name="cwordslistForm" id="cwordslistForm" method="post">
		<div class="place">
			<span>位置：</span>
			<ul class="placeul">
		...
		<div class="rightinfo">
			...
			<div class="pagin">
				...
				<ul class="paginList">
					...
					%>
					<li class="paginItem"><a href="<%=basePath%>cwords/cwords_doFindByAdminId.action?adminid=<%=adminid %>&currentPage=<%=firstPage-PAGE_SIZE%>">
					...
					<li class="paginItem current"><a href="<%=basePath%>cwords/cwords_doFindByAdminId.action?adminid=<%=adminid %>&currentPage=<%=i%>"><%=i%></a></li>
					<%
						continue;}
					%>

					<li class="paginItem"><a href="<%=basePath%>cwords/cwords_doFindByAdminId.action?adminid=<%=adminid %>&currentPage=<%=i%>"><%=i%></a></li>
					<%
						}
					%>
					<%
