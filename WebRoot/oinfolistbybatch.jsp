...
<%
    ...
    int batchid	=	(Integer)request.getAttribute("batchid");  //一共多少记录
...
<body>
	<form action="<%=basePath%>oinfo/oinfo_doFind.action?batchid=<%=batchid %>" name="oinfolistForm" id="oinfolistForm" method="post">
		<div class="place">
			<span>位置：</span>
			<ul class="placeul">
			...
			<li1><a href="<%=basePath%>gbatch/gbatch_doView.action?gbatch.batchId=<%=batchid%>">批次详情</a></li1>
		...
		<div class="rightinfo">
			...
			<div class="pagin">
				...
				<ul class="paginList">
					...
					%>
					<li class="paginItem"><a href="<%=basePath%>oinfo/oinfo_doFind.action?batchid=<%=batchid%>&currentPage=<%=firstPage-PAGE_SIZE%>&keyword=<%=keyword%>">
					...
					<li class="paginItem current"><a href="<%=basePath%>oinfo/oinfo_doFind.action?batchid=<%=batchid%>&currentPage=<%=i%>&keyword=<%=keyword%>"><%=i%></a></li>

					<%
						continue;}
					%>

					<li class="paginItem"><a href="<%=basePath%>oinfo/oinfo_doFind.action?batchid=<%=batchid%>&currentPage=<%=i%>&keyword=<%=keyword%>"><%=i%></a></li>
