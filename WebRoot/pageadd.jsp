...
<body>
	<form action="<%=basePath%>page/page_doUpdate.action" onsubmit="return checkForm();" enctype="multipart/form-data" name="form1" method="post">
		<div class="place">
			...
			<li1><a style="color:blue;" href="<%=basePath%>page/page_beforedoAdd.action">商品轮播图添加</a></li1>
			<li1><a href="<%=basePath%>page/page_doEdit.action">商品轮播图更新</a></li1>
					...
					<div style="margin-left:100px;" class="tabson">
						...
						<div style="width: 440px;height:310px;border-color: green;border-style: inset;border-width: 1px;border-radius:18px;margin:20px 20px 20px 20px;float: left;background: none repeat scroll 0% 0% rgb(243, 249, 240);">
							<ul style="float:left;width: 400px;height:280px;margin:10px 10px 10px 10px;">
								<li style="width:400px;margin:5px 10px 5px 10px;"><label style="margin-left:20px;width:380px;font-size: 13px;color: #03408f;font-family: 微软雅黑;">轮播图1:请选择分辨率约为1080*986的图片</label></li>

								<li style="width:400px;margin:5px 10px 5px 10px;clear: both;color: #D6D6D6;">
									<div id="localImage1">
										<img src="../uploads/page.jpg" id="preview1" style="width: 380px;height: 200px;border-radius:18px;diplay: none;margin:10px 10px 10px 10px;" />
									</div>
								</li>
								<li style="width:400px;margin:5px 10px 5px 10px;"><input type="hidden" id="url1" name="img1" value="" /></li>
								<li style="width:280px;margin:10px 70px 10px 70px;"><input name="goodsid1" id="goodsid1" type="text" value="" class="dfinput" placeholder="请输入该轮播图的商品ID" style="padding-left:50px;width:280px;" /></li>
							</ul>
						</div>
						<div style="width: 440px;height:310px;border-color: green;border-style: inset;border-width: 1px;border-radius:18px;margin:20px 20px 20px 20px;float: left;background: none repeat scroll 0% 0% rgb(243, 249, 240);">
							<ul style="float:left;width: 400px;height:280px;margin:10px 10px 10px 10px;">
								...
								<li style="width:400px;margin:5px 10px 5px 10px;clear: both;color: #D6D6D6;">
									<div id="localImage2">
										<img src="../uploads/page.jpg" id="preview2" style="width: 380px;height: 200px;border-radius:18px;diplay: none;margin:10px 10px 10px 10px;" />
									</div>
								</li>
								<li style="width:400px;margin:5px 10px 5px 10px;"><input type="hidden" id="url2" name="img2" value="" /></li>
								<li style="width:280px;margin:10px 70px 10px 70px;"><input name="goodsid2" id="goodsid2" type="text" value="" class="dfinput" placeholder="请输入该轮播图的商品ID" style="padding-left:50px;width:280px;" /></li>
							</ul>
						</div>
						<div style="width: 440px;height:310px;border-color: green;border-style: inset;border-width: 1px;border-radius:18px;margin:20px 20px 20px 20px;float: left;background: none repeat scroll 0% 0% rgb(243, 249, 240);">
							<ul style="float:left;width: 400px;height:280px;margin:10px 10px 10px 10px;">
								...
								<li style="width:400px;margin:5px 10px 5px 10px;clear: both;color: #D6D6D6;">
									<div id="localImage3">
										<img src="../uploads/page.jpg" id="preview3" style="width: 380px;height: 200px;border-radius:18px;diplay: none;margin:10px 10px 10px 10px;" />
									</div>
								</li>
								<li style="width:400px;margin:5px 10px 5px 10px;"><input type="hidden" id="url3" name="img3" value="" /></li>
								<li style="width:280px;margin:10px 70px 10px 70px;"><input name="goodsid3" id="goodsid3" type="text" value="" class="dfinput" placeholder="请输入该轮播图的商品ID" style="padding-left:50px;width:280px;" /></li>
							</ul>
						</div>
						<div style="width: 440px;height:310px;border-color: green;border-style: inset;border-width: 1px;border-radius:18px;margin:20px 20px 20px 20px;float: left;background: none repeat scroll 0% 0% rgb(243, 249, 240);">
							<ul style="float:left;width: 400px;height:280px;margin:10px 10px 10px 10px;">
								...
								<li style="width:400px;margin:5px 10px 5px 10px;clear: both;color: #D6D6D6;">
									<div id="localImage4">
										<img src="../uploads/page.jpg" id="preview4" style="width: 380px;height: 200px;border-radius:18px;diplay: none;margin:10px 10px 10px 10px;" />
									</div>
								</li>
								<li style="width:400px;margin:5px 10px 5px 10px;"><input type="hidden" id="url4" name="img4" value="" /></li>
								<li style="width:280px;margin:10px 70px 10px 70px;"><input name="goodsid4" id="goodsid4" type="text" value="" class="dfinput" placeholder="请输入该轮播图的商品ID" style="padding-left:50px;width:280px;" /></li>
							</ul>
						</div>
						<div class="ibox1"></div>
