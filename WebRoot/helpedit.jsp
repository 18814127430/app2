...
<form action="<%=basePath%>/help/help_doUpdate.action" method="post" onsubmit="return checkForm();" enctype="multipart/form-data" name="form1">
		<div class="place">
			...
			<li1><a href="<%=basePath%>mainindex.jsp">首页</a></li1>
				...
				<li1><a href="<%=basePath%>help/help_doView.action?help.helpId=<%=help.getHelpId()%>">帮助详情</a></li1>
				<li1><a href="<%=basePath%>help.jsp">帮助添加</a></li1>
				<li1><a  style="color:blue;" href="<%=basePath%>help/help_doEdit.action?help.helpId=<%=help.getHelpId()%>">帮助修改</a></li1>
