...
<body>
	<form action="<%=basePath%>/customer/customer_doFind.action" name="customerForm" id="customerForm" method="post">
		<div class="place">
			<span>位置：</span>
			<ul class="placeul">
			<li1><a href="<%=basePath%>mainindex.jsp">首页</a></li1>
			<li1><a  style="color:blue;" href="<%=basePath%>customer.jsp">顾客查找</a></li1>
		...
		<div class="mainindex">
			...
			<ul class="seachform">
				<li><label>顾客综合查询</label> <input type="text" name="keyword" value="" placeholder="请输入关键字" class="scinput" /></li>
			...
			<ul class="iconlist">
				<li><img src="<%=basePath%>images/customer1.png" />
					<p>
						<a href="<%=basePath%>customer/customer_doFind.action">顾客列表</a>
					</p></li>
				<li><img src="<%=basePath%>images/customer3.png" />
					<p>
						<a href="<%=basePath%>customeradd.jsp">顾客添加</a>
					</p></li>
			</ul>
			<div class="ibox"></div>
			<div class="ibox"></div>
