...
<body>
	<form action="<%=basePath%>push/push_doFind.action" name="pushlistForm" id="pushForm" method="post">
		...
		<div class="mainindex">
			...
			<div class="xline"></div>
			<ul class="iconlist">
				<li><img src="<%=basePath%>images/push1.png" />
					<p>
						<a href="<%=basePath%>push/push_doFind.action">信息推送列表</a>
					</p></li>
				<li><img src="<%=basePath%>images/push3.png" />
					<p>
						<a href="<%=basePath%>pushadd.jsp">信息推送添加</a>
					</p></li>
			</ul>
			<div class="ibox"></div>
			<div class="ibox"></div>
			...
			<ul class="umlist">
				...
				<li><a href="<%=basePath%>">信息推送权限设置</a></li>
