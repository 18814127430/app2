...
<body>
	<div class="place">
		...
		<li1><a href="<%=basePath%>mainindex.jsp">首页</a></li1>
				...
				<li1><a style="color:blue;" href="<%=basePath%>oorder/oorder_doFind_S.action">待发货订单</a></li1>
				<li1><a href="<%=basePath%>oorder/oorder_doFind_R.action">待退款订单</a></li1>
				...
				<div class="tabson">
					...
					<div style="width: 300px;height:630px;border-color: white;border-style: hidden;border-width: 1px;border-radius:18px;margin:20px 20px 20px 20px;float: left;background: none repeat scroll 0% 0% rgb(243, 249, 240);">
						<ul style="float:left;width: 260px;height:600px;margin:10px 10px 10px 10px;">
							...
							<li style="width:260px;margin:5px 30px 5px 30px;"><label style="margin-left:60px;width:240px;font-size: 13px;color: #03408f;font-family: 微软雅黑;">已付款、待发货</label></li>
							<%} %>
							...
							<input onclick="javascript:location.href='<%=basePath%>oorder/oorder_doUpdate_Send.action?orderid=<%=oorder.getOrderId()%>'" type="button" value="发货" class="btn1" />
							</label>
