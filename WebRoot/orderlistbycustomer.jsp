...
<%
    ...
    String keyword 	=   (String)request.getAttribute("keyword");  //一共多少页
...
<body>
	<form action="<%=basePath%>order/order_doFindByCustomerId.action" name="orderlistForm" id="orderlistForm" method="post">
		<div class="place">
			<span>位置：</span>
			<ul class="placeul">
		...
		<div class="rightinfo">
			...
			<table class="tablelist">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="<%=basePath%>order/order_doView.action?order.orderId=<%=order.getOrderId()%>" style="cursor:hand;" class="tablelink">详情</a></td>
					</tr>
					<%
						}
					%>
			...
			<div class="pagin">
				...
				<ul class="paginList">
					...
					%>
					<li class="paginItem"><a href="<%=basePath%>order/order_doFindByCustomerId.action?customerid=<%=customerid%>&currentPage=<%=firstPage-PAGE_SIZE%>">
					...
					<li class="paginItem current"><a href="<%=basePath%>order/order_doFindByCustomerId.action?customerid=<%=customerid%>&currentPage=<%=i%>"><%=i%></a></li>

					<%
						continue;}
					%>

					<li class="paginItem"><a href="<%=basePath%>order/order_doFindByCustomerId.action?customerid=<%=customerid%>&currentPage=<%=i%>"><%=i%></a></li>
